...
BOT_TOKEN = environ.get('BOT_TOKEN', "6364797527:AAExTMRpxHAWXBFt7y-x0r_NxFIgS7Kfknw")

# Bot settings
CACHE_TIME = int(environ.get('CACHE_TIME', 1800))
PICS = (environ.get('PICS', 'https://graph.org/file/d5959f9cee741a653318f.jpg')).split() #SAMPLE PIC
NOR_IMG = environ.get("NOR_IMG", "https://graph.org/file/d5959f9cee741a653318f.jpg")
MELCOW_VID = environ.get("MELCOW_VID", "https://graph.org/file/d5959f9cee741a653318f.jpg")
SPELL_IMG = environ.get("SPELL_IMG", "https://te.legra.ph/file/15c1ad448dfe472a5cbb8.jpg")

# Admins, Channels & Users
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002233093561'))
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '7183298184').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002185397822').split()]
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002077540375') # give your force subscribe channel id here else leave it blank
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/MoviesMafiaSearch')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/Movies_Mafia_Updates')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/How_To_Open_Linkl')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'MoviesMafiaSearch') # Support Chat Link Without https:// or @
